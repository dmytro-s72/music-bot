...
# URL: https://www.youtube.com/watch?v=pStL3J_Cg-c
...
def fix_cookies():
    ...
    if not os.path.exists(cookie_file):
        print("Файл cookies.txt не знайдено!")
        return
    ...
    for line in lines:
        ...
        # Розбиваємо рядок по будь-яких пропусках (пробіли або таби)
        parts = line.split()
        if len(parts) >= 7:
            # Склеюємо назад через справжній символ табуляції \t
